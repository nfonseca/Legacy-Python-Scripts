#!/usr/bin/python
#***************************************************************************
#    amber_mden_analyzer.py
#	- Python script for the transformation of mden to a XY file for
#                 graphic display
#                             -------------------
...
timestep=float(raw_input("Enter the Time Step: "))	# time step used in the MD
ntwe=int(raw_input("Enter the Value of ntwe: "))	# output frequency of the mden file
...
while i < len(lines_split) or j < len(lines_split):
    ...
    timetemp=timestep*ntwe*step

    i=i+51
    j=j+51

    Nsteps_file.write("\t" + str(step) + "\t" + str(timetemp) + "\n")
...
while j<len(lines_split) or k<len(lines_split) :
    ...
    Etot_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Etot) + "\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or l<len(lines_split) :
    ...
    EKinetic_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%EKinetic) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or m<len(lines_split) :
    ...
    Temp_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Temp) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or n<len(lines_split) :
    ...
    T_solute_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%T_solute) + "\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or o<len(lines_split) :
    ...
    T_solv_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%T_solv) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or p<len(lines_split) :
    ...
    Pres_scal_solu_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Pres_scal_solu) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or q<len(lines_split) :
    ...
    Pres_scal_solv_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Pres_scal_solv) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or r<len(lines_split) :
    ...
    BoxX_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%BoxX) + "\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or s<len(lines_split) :
    ...
    BoxY_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%BoxY) +"\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or t<len(lines_split) :
    ...
    BoxZ_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%BoxZ) + "\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or u<len(lines_split) :
    ...
    volume_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%volume) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or v<len(lines_split) :
    ...
    pres_X_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%pres_X) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or w<len(lines_split) :
    ...
    pres_Y_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%pres_Y) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or y<len(lines_split) :
    ...
    pres_Z_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%pres_Z) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or z<len(lines_split) :
    ...
    Pressure_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Pressure) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or kk<len(lines_split) :
    ...
    EKCoM_x_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%EKCoM_x) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or ll<len(lines_split) :
    ...
    EKCoM_y_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%EKCoM_y) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or mm<len(lines_split) :
    ...
    EKCoM_z_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%EKCoM_z) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or nn<len(lines_split) :
    ...
    EKComTot_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%EKComTot) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or oo<len(lines_split) :
    ...
    VIRIAL_x_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%VIRIAL_x) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or pp<len(lines_split) :
    ...
    VIRIAL_y_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%VIRIAL_y) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or qq<len(lines_split) :
    ...
    VIRIAL_z_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%VIRIAL_z) +"\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or rr<len(lines_split) :
    ...
    VIRIAL_tot_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%VIRIAL_tot) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or ss<len(lines_split) :
    ...
    E_pot_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_pot) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or tt<len(lines_split) :
    ...
    E_vdw_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_vdw) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or uu<len(lines_split) :
    ...
    E_el_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_el) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or vv<len(lines_split) :
    ...
    E_hbon_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_hbon) + "\t\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or ww<len(lines_split) :
    ...
    E_bon_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_bon) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or yy<len(lines_split) :
    ...
    E_angle_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_angle) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or zz<len(lines_split) :
    ...
    E_dih_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_dih) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or kkk<len(lines_split) :
    ...
    E_14vdw_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_14vdw) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or lll<len(lines_split) :
    ...
    E_14el_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_14el) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or mmm<len(lines_split) :
    ...
    E_const_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_const) + "\t\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or nnn<len(lines_split) :
    ...
    E_pol_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%E_pol) + "\t\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or ooo<len(lines_split) :
    ...
    AV_permMoment_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%AV_permMoment) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or ppp<len(lines_split) :
    ...
    AV_indMoment_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%AV_indMoment) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or qqq<len(lines_split) :
    ...
    AV_totMoment_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%AV_totMoment) + "\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or rrr<len(lines_split) :
    ...
    Density_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%Density) + "\t\t\t\t" + str('%.3f'%average) + "\n")
...
while j<len(lines_split) or sss<len(lines_split) :
    ...
    dV_dlambda_file.write("\t" + str(timetemp) + "\t\t" + str('%.3f'%dV_dlambda) + "\t\t\t" + str('%.3f'%average) + "\n")
